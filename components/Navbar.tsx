      ...
      <div className="container mx-auto px-6 flex justify-between items-center">
        <a href="#home" className="flex items-center gap-2 group">
          ...
          <div className="flex flex-col">
            <span className="font-heading font-bold text-xl md:text-5xl text-brand-pink leading-tight">
              SREE VEDA
            </span>
            <span className="text-[10px] md:text-2xl font-bold text-green-600 uppercase tracking-widest">
